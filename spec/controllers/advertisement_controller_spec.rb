...
RSpec.describe AdvertisementController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of advertisement by 1" do
      expect{post :create, advertisement: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 11 }}.to change(Advertisement,:count).by(1)
    end

    it "assigns the new post to @advertisement" do
      post :create, advertisement: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: 11}
